page 50101 ReservationEntries
{
    ...
    var
        ReservastonEntry: Record "Reservation Entry";
    begin
        ReservastonEntry.Get(Rec."Entry No.", true);
        FromLineNo := ReservastonEntry."Source Ref. No.";
        ReservastonEntry.Get(Rec."Entry No.", false);
        ForLineNo := ReservastonEntry."Source Ref. No.";
    end;
